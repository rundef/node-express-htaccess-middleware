...
describe('rewrite rules', function() {
  ...
  it('simple', function (done) {
    ...
    expect(rule.matches('foo.html?a=1')).to.be.null;
    expect(rule.matches('foo.html')).to.be.equal('test.html');
  ...
  it('with variables', function (done) {
    ...
    expect(rule.matches('article-1-2.html')).to.be.equal('/articles/article.php?id=1&cat=2');
    expect(rule.matches('article-34567-987654.html')).to.be.equal('/articles/article.php?id=34567&cat=987654');
  ...
  it('with variables #2', function (done) {
    ...
    expect(rule.matches('article-1-2.html')).to.be.equal('/articles/article.php?id=1&cat=2&catid=2');
    expect(rule.matches('article-34567-987654.html')).to.be.equal('/articles/article.php?id=34567&cat=987654&catid=987654');
